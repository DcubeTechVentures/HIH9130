...
/*
        ...
        HIH9130
        This code is designed to work with the HIH9130_I2CS I2C Mini Module available from www.dcubestore.com.
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ...
        Serial.println("Getting Readings from HIH9130");
        Serial.println(" ");
    ...
    {
        Serial.println("HIH9130 Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
